...
function train_scaled(){
    ...
    # encoder_ffn_embed_dim=$(python -c "print($width /12 * $encoder_embed_dim * 4)")
    encoder_ffn_embed_dim=$(python -c "print($width)") #baseline is 12*64*4 = 3072. suggest to scan 3072 * 2^-k : k = 3,4,5,6,7,8
